      ...
      <View>
        <View style={styles.userBar}>
          <View style={styles.userInfo}>
            <Image
              ...
              source={{
                uri:
                  'https://lh3.googleusercontent.com/XjPWx8hu_LuIyMXWg_kp5SnsZBT5Nz9WwjBgj_ck-tZIKk_aiNab_HD3FbAa6U71qpxojTOXTAZ_Cn9c1Y1HZ0JTOLE',
              }}
            />
            <Text>Amy</Text>
          </View>
        ...
        <View style={styles.iconBar}>
          <Image
            style={[
              styles.icon,
              { height: 40, width: 40, tintColor: heartTint },
            ]}
        ...
        <View style={styles.commentBar}>
          <Image
            style={[styles.icon, { height: 30, width: 30, marginRight: 7 }]}
            source={config.images.heartIcon}
          />
          <Text>120 Likes</Text>
        </View>
...
Post.defaultProps = {
  imageSrc:
    'https://lh3.googleusercontent.com/vj5YsrWwmHZpUmgV5tz1YeWPYc8Dnrq_fAG-TCw4FziC-LBSLUZKXprRN4UnLyZBRWNg9_wd0fp0c8_Ne2KPo6SJVYA',
};
